...
Config = namedtuple('Config', ['epsilon_start', 'epsilon_final', 'epsilon_decay', 
                               ...
                               'atari_preprocessing', 'frame_stack', 'clip_rewards', 'terminal_on_life_loss'])
...
ConfigCartPole = Config(epsilon_start=0.0, epsilon_final=0.02, epsilon_decay=5_000,
                        ...
                        atari_preprocessing=False, frame_stack=False, clip_rewards=True, terminal_on_life_loss=False)
...
ConfigBrakeout = Config(epsilon_start=1.0, epsilon_final=0.1, epsilon_decay=1_000_000,
                        ...
                        gamma=0.99, update_frequency=4, replay_buffer_capacity=300_000, 
                        env_name='BreakoutNoFrameskip-v4', learning_rate=0.00025, population_size=1000, 
                        noise_std=0.01, mutation_rate=0.05, parent_count=200, worker_count=10, hybrid_epochs=50, hybrid_scale=0.1,
                        hybrid_quantize_count=4, hybrid_epsilon=0.01, hybrid_gradient_frequency=100, model_name='DQNHuman',
                        atari_preprocessing=True, frame_stack=True, clip_rewards=True, terminal_on_life_loss=True)
